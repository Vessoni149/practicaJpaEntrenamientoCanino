...
public class MascotaJpaController implements Serializable {
    ...
    public MascotaJpaController(EntityManagerFactory emf) {
     ...
     public MascotaJpaController(){
        emf = Persistence.createEntityManagerFactory("EntrenamientoCaninoPU");
    }
    ...
    public void edit(Mascota mascota) throws NonexistentEntityException,
            Exception {
        EntityManager em = null;
        try {
            em = getEntityManager();
            ...
            if (msg == null || msg.length() == 0) {
                ...
                if (findMascota(id) == null) {
                    throw new NonexistentEntityException("The mascota with id " +
                            id + " no longer exists.");
                }
            }
            throw ex;
    ...
    public void destroy(int id) throws NonexistentEntityException {
        ...
        try {
            ...
            try {
                ...
                throw new NonexistentEntityException("The mascota with id " + id +
    ...
    private List<Mascota> findMascotaEntities(boolean all, int maxResults,
            int firstResult) {
