...
public class DuenioJpaController implements Serializable {
        ...
        try {
            ...
            if (msg == null || msg.length() == 0) {
                ...
                if (findDuenio(id) == null) {
                    throw new NonexistentEntityException("The duenio with id " +
                            id + " no longer exists.");
                }
            }
            throw ex;
    ...
    public void destroy(int id) throws NonexistentEntityException {
        ...
        try {
            ...
            try {
                ...
                throw new NonexistentEntityException("The duenio with id " + id +
    ...
    private List<Duenio> findDuenioEntities(boolean all, int maxResults,
            int firstResult) {
